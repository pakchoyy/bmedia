...
export default function GameCard({ media }: { media: Media }) {
  return (
    <Link
      href={`/media/${media.id}`}
      className="group bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200 hover:-translate-y-2 hover:shadow-md hover:border-primary-light transition-all duration-300 flex flex-col"
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        <h3 className="text-lg font-bold text-ink leading-snug mb-2 line-clamp-2">
          {media.title}
        </h3>
        ...
        <div className="text-sm text-primary font-medium mt-auto border-t border-gray-200 pt-3">
